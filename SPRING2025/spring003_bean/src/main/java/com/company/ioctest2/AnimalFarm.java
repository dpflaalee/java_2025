...
public class AnimalFarm {
	...
	@Autowired @Qualifier("cat") private Animal ani; // 여러개있으면 Qualifier로 분류해서 사용해야
	...
	public Animal getAni() { return ani; } public void setAni(Animal ani) { this.ani = ani; }

	@Override public String toString() { return "AnimalFarm [name=" + name + ", ani=" + ani + "]"; }
