     ...
     public  ArrayList<BoardVO>  selectAll( ){  
		...
		while(rset.next()) {//줄
			result.add( 
					...
					rset.getString("bname"), rset.getInt("bhit"), rset.getString("bdate"), rset.getString("bip") )
					);
		}
...
//	3. 글읽기/글수정폼	-  select * from board where  bno =? 
...
//	5. 글수정기능	-  update  board  set  btitle=? , bcontent=?  where bno=?
...
//	6. 글삭제	-  delete   from board  where bno=?
