...
const reducer = (state = initialState, action) => produce(state, (draft) => { 
   ...
   ///////////////////////////  Load_POST
      ...
      case LOAD_POSTS_SUCCESS:
         ...
         draft.mainPosts = action.data.concat(draft.mainPosts); //tofhdnsepdlxj 10 + 기존데이터
         console.log('..................mainpost', action.data.concat(draft.mainPosts).length);
         draft.hasMorePosts = draft.mainPosts.length <50 ; // 게시물 50개부근 보이게
         break;
