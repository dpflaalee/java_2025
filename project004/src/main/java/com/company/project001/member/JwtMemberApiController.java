...
@CrossOrigin(origins = "http://localhost:3000") // 해당 도메인에서 요청오는거 허용
@RestController									//json 형식으로 던지는 컨트롤러 : JWT용
...
public class JwtMemberApiController {
     ...
     */
    @PostMapping("/join")
    public ResponseEntity<?> join(@Valid @RequestBody MemberJoinForm form) { //빈칸검사 및 상태표기
