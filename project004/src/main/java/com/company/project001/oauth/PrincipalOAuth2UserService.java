...
//		Log.info("1. ........getAttributes:{}", oAuth2User.getAttributes());
		System.out.println("1. ........getAttributes:{}" + oAuth2User.getAttributes());
		
		String provider = userRequest.getClientRegistration().getRegistrationId();
		UserInfoOAuth2 info = null;
		
		if("google".equals(provider)) {info = new UserInfoGoogle(oAuth2User.getAttributes());}
		else if("kakao".equals(provider)) {info = new UserInfoKakao(oAuth2User.getAttributes());}
		else if("naver".equals(provider)) {info = new UserInfoNaver(oAuth2User.getAttributes());}
...
// UserInfoOAuth2 > 정보 저장
// PrincipalOAuth2UserService > DB상 데이터 체크 후 끌어오기
