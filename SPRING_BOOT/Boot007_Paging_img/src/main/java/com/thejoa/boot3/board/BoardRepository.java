...
//	@Query(value="select*from board order by id desc", nativeQuery=true) //버전따라 오류나기도 해서 권장하지 않음
	...
	@Query("update from Board b set b.btitle=:btitle, b.bcontent=:bcontent, b.bfile=:bfile where b.id= :id and b.bpass= :bpass")
	int updateByIdBpass(Long id, String bpass, String btitle, String bcontent, String bfile);
